...
private:
    ...
    */
     ...
     *          Based on 4th order Runge-Kutta and adding quality control (adaptive stepsize), such that we can kind of achieve 5th order accuracy
     ...
     * @param Y_Scale, input: the scale in y to set the error (it is possible in different direction of y, the scale is quite different)
    ...
    */
    void RKQC_SingleStep(REAL &x, VD &y, VD &dy, const REAL step_size_guess, const REAL eps, const VD &Y_Scale, REAL &step_size_did, REAL &step_size_further);
};
