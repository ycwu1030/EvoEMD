...
public:
    ...
    void Set_Nu_MassOrdering(
        Nu_TypeI_SeeSaw::MassOrdering od = Nu_TypeI_SeeSaw::NORMAL_ORDER);
...
private:
    ...
    friend int gamma_Integrand(const int *ndim, const REAL x[],
                               const int *ncomp, REAL ff[], void *_params);
};
